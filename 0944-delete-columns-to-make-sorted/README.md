<h2><a href="https://leetcode.com/problems/delete-columns-to-make-sorted/solution/">944. Delete Columns to Make Sorted</a></h2><h3>Easy</h3><hr><div><p>You are given an array of <code>n</code> strings <code>strs</code>, all of the same length.</p>
